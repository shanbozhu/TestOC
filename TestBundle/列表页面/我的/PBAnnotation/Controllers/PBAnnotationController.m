...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    if ([mapName isEqualToString:@"高德地图"]) {
        NSString *urlStr = [NSString stringWithFormat:@"iosamap://navi?sourceApplication=%@&backScheme=%@&lat=%f&lon=%f&dev=0&style=2", @"TestBundle", @"TestBundleAAA", self.annotation.coordinate.latitude, self.annotation.coordinate.longitude];
        urlStr = [urlStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
