...
- (void)viewDidLoad {
    ...
    
    {
        ...
        // 强制转换和调用分开
        NSString *(*msgSend)(id, SEL, NSString *, NSString *, NSString *) = (void *)objc_msgSend;
        NSString *r = msgSend(self, @selector(runA:b:c:), @"a", @"b", @"c");
        NSLog(@"%@", r);
        
        // 强制转换和调用一起
        NSString *r1 = ((NSString *(*)(id, SEL, NSString *, NSString *, NSString *))objc_msgSend)(self, @selector(runA:b:c:), @"a", @"b", @"c");
        NSLog(@"%@", r1);
