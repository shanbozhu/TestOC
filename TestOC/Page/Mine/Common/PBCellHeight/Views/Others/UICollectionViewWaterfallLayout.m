...
@property (nonatomic, strong) NSMutableArray *attributeArray; // frame 数组
@property (nonatomic, assign) NSInteger collectViewRowCount;  // 列数
@property (nonatomic, strong) NSMutableArray *originYAry;    //记录每一列的Y点坐标
